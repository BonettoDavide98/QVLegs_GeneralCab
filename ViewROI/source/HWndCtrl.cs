...
namespace ViewROI
{
    ...
    public class HWndCtrl
    {
        ...
        public System.Drawing.Rectangle rectMainSetPart = System.Drawing.Rectangle.Empty;
        public float ratioMainSetPart = 0;
        ...
        public void setImagePart(int r1, int c1, int r2, int c2)
        {
            ...
            double dx = rectMainSetPart.X / ratioMainSetPart;
            double dy = rectMainSetPart.Y / ratioMainSetPart;

            ImgRow1 = (int)-dy;
            ImgCol1 = (int)-dx;
            ImgRow2 = (int)(imageHeight + dy);
            ImgCol2 = (int)(imageWidth + dx);

            System.Drawing.Rectangle rect = viewPort.ImagePart;
            rect.X = (int)ImgCol1;
            rect.Y = (int)ImgRow1;
            rect.Width = (int)(ImgCol2 + dx);
            rect.Height = (int)(ImgRow2 + dy);
        ...
        public void scaleWindow(double scale)
        {
            ...
            ImgRow1 = (int)-dy;
            ImgCol1 = (int)-dx;
            ImgRow2 = (int)(imageHeight + 2 * dy);
            ImgCol2 = (int)(imageWidth + 2 * dx);
        ...
        public void repaint(HalconDotNet.HWindow window)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if ((ShowOnlyImages && entry.HObj is HImage) || !ShowOnlyImages)
                {
