...
{
    public partial class UCStep15Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep15Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Ingombro diametro 18";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMin.Value = (decimal)param.ThresholdBlueCenter;
            nudAreaMaxCircle.Value = (decimal)param.AreaMaxBlueCenter;

            this.roi1 = new ViewROI.ROICircle();
            this.roi1.setModelData(new HalconDotNet.HTuple(param.CircleBlueCenter.Row, param.CircleBlueCenter.Column, param.CircleBlueCenter.Radius));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step15Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN1)
                {
                    this.algoritmoWizard.SetRoiCam4_Foto1_BlueCenter(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdBlueCenter = (double)nudThresholdMin.Value;
                param.AreaMaxBlueCenter = (double)nudAreaMaxCircle.Value;
