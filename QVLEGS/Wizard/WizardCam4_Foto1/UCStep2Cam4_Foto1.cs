...
{
    public partial class UCStep2Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        //MODIFY ON NEW STEP
        public UCStep2Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Molleta lat. M.";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
                ...
                lblDistMax.Text = linguaManager.GetTranslation("LBL_AREA_MIN");
                btnDisegnaRettangolo.Text = linguaManager.GetTranslation("BTN_ROI_RECT");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThreshold.Value = (decimal)param.ThresholdGrayLeft;
            nudDistMax.Value = (decimal)param.AreaMinGrayLeft;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectGrayLeft.Row1, param.RectGrayLeft.Column1, param.RectGrayLeft.Row2, param.RectGrayLeft.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step2Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiLeftCam4_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdGrayLeft = (double)nudThreshold.Value;
                param.AreaMinGrayLeft = (double)nudDistMax.Value;
