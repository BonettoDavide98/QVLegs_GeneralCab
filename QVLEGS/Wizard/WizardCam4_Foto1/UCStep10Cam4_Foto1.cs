...
{
    public partial class UCStep10Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep10Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Ingombro sopra varistore";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMax.Value = (decimal)param.ThresholdBlueUp;
            nudDistMax.Value = (decimal)param.AreaMaxBlueUp;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectBlueUp.Row1, param.RectBlueUp.Column1, param.RectBlueUp.Row2, param.RectBlueUp.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step10Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiBlueUpCam4_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdBlueUp = (double)nudThresholdMax.Value;
                param.AreaMaxBlueUp = (double)nudDistMax.Value;
