...
{
    public partial class UCStep3Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep3Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Molleta lat. P.";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMax.Value = (decimal)param.ThresholdGrayRight;
            nudDistMax.Value = (decimal)param.AreaMinGrayRight;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectGrayRight.Row1, param.RectGrayRight.Column1, param.RectGrayRight.Row2, param.RectGrayRight.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step3Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiRightCam4_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdGrayRight = (double)nudThresholdMax.Value;
                param.AreaMinGrayRight = (double)nudDistMax.Value;
