...
{
    public partial class UCStep13Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep13Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Presenza induttanza lat. P.";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMax.Value = (decimal)param.ThresholdRedLeft;
            nudDistMax.Value = (decimal)param.AreaMaxRedLeft;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectRedLeft.Row1, param.RectRedLeft.Column1, param.RectRedLeft.Row2, param.RectRedLeft.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step13Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiRedLeftCam4_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdRedLeft = (double)nudThresholdMax.Value;
                param.AreaMaxRedLeft = (double)nudDistMax.Value;
