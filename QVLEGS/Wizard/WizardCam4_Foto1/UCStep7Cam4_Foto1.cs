...
{
    public partial class UCStep7Cam4_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep7Cam4_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam4_Foto1_Step7Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdYellowCenter = (double)nudThresholdMin.Value;
                param.AreaMaxYellowCenter = (double)nudAreaMaxCircle.Value;
