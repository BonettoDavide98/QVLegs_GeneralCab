...
{
    public partial class UCStep4Cam3_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep4Cam3_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDistMax.Text = linguaManager.GetTranslation("LBL_DIST_MAX_3_CAM3");
                lblDistMin.Text = linguaManager.GetTranslation("LBL_DIST_MIN_3_CAM3");
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto1_Step4Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto1_Height_2(data);
