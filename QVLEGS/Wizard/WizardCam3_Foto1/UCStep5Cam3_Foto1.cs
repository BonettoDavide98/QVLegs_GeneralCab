...
{
    public partial class UCStep5Cam3_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep5Cam3_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDistMax.Text = linguaManager.GetTranslation("LBL_DIST_MAX_4_CAM3");
                lblDistMin.Text = linguaManager.GetTranslation("LBL_DIST_MIN_4_CAM3");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudDistMax.Value = (decimal)param.DistMax_Calipper_2;
            nudDistMin.Value = (decimal)param.DistMin_Calipper_2;

            this.roi = new ViewROI.ROIRectangle2();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectCalipper_2.Row, param.RectCalipper_2.Column, param.RectCalipper_2.Angle, param.RectCalipper_2.Length1, param.RectCalipper_2.Length2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto1_Step5Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto1_Calipper_2(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.DistMax_Calipper_2 = (double)nudDistMax.Value;
                param.DistMin_Calipper_2 = (double)nudDistMin.Value;
