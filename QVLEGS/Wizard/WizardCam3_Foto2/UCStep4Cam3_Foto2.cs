...
{
    public partial class UCStep4Cam3_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep4Cam3_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDistMax.Text = linguaManager.GetTranslation("LBL_DIST_MAX_2_CAM3");
                lblDistMin.Text = linguaManager.GetTranslation("LBL_DIST_MIN_2_CAM3");
        ...
        {
            DataType.Cam3_Foto2Param param = paramAlg.Cam3_Foto2Param;
            nudDistMax.Value = (decimal)param.DistMax_Height_3;
            nudDistMin.Value = (decimal)param.DistMin_Height_3;

            this.roi = new ViewROI.ROIRectangle2();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectHeight_3.Row, param.RectHeight_3.Column, param.RectHeight_3.Angle, param.RectHeight_3.Length1, param.RectHeight_3.Length2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto2_Step4Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto2_Height_3(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                DataType.Cam3_Foto2Param param = this.algoritmoWizard.GetAlgoritmoParam().Cam3_Foto2Param;
                param.DistMax_Height_3 = (double)nudDistMax.Value;
                param.DistMin_Height_3 = (double)nudDistMin.Value;
