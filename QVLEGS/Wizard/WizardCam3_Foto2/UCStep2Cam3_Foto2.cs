...
{
    public partial class UCStep2Cam3_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep2Cam3_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudDistMax.Value = (decimal)param.DistMax_Height_1;
            nudDistMin.Value = (decimal)param.DistMin_Height_1;

            this.roi = new ViewROI.ROIRectangle2();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectHeight_1.Row, param.RectHeight_1.Column, param.RectHeight_1.Angle, param.RectHeight_1.Length1, param.RectHeight_1.Length2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto2_Step2Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto2_Height_1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.DistMax_Height_1 = (double)nudDistMax.Value;
                param.DistMin_Height_1 = (double)nudDistMin.Value;
