...
{
    public partial class UCStep3Cam3_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep3Cam3_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudDistMax.Value = (decimal)param.DistMax_Height_2;
            nudDistMin.Value = (decimal)param.DistMin_Height_2;

            this.roi = new ViewROI.ROIRectangle2();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectHeight_2.Row, param.RectHeight_2.Column, param.RectHeight_2.Angle, param.RectHeight_2.Length1, param.RectHeight_2.Length2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto2_Step3Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto2_Height_2(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.DistMax_Height_2 = (double)nudDistMax.Value;
                param.DistMin_Height_2 = (double)nudDistMin.Value;
