...
{
    public partial class UCStep1Cam3_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep1Cam3_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectRif_1.Row, param.RectRif_1.Column, param.RectRif_1.Angle, param.RectRif_1.Length1, param.RectRif_1.Length2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam3_Foto2_Step1Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    this.algoritmoWizard.SetRoiCam3_Foto2_Height_Riff(data);
