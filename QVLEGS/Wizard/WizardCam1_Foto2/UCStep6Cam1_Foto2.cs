...
{
    public partial class UCStep6Cam1_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep6Cam1_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Varistore pin 1";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto2_Step6Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
