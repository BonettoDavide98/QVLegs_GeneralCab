...
{
    public partial class UCStep17Cam1_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep17Cam1_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                btnDrawRect1.Text = linguaManager.GetTranslation("BTN_ROI_7_CAM2");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            ucCheckbox1.Checked = param.Hole_7;
            nudAreaMaxBlack.Value = (decimal)param.AreaMAxSmall_7;
            nudAreaMinBlack.Value = (decimal)param.AreaMinSmall_7;

            this.roi1 = new ViewROI.ROIRectangle1();
            this.roi1.setModelData(new HalconDotNet.HTuple(param.smallRect_7.Row1, param.smallRect_7.Column1, param.smallRect_7.Row2, param.smallRect_7.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto2_Step17Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == bigRect_1)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto2_SmallRec_7(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.AreaMinSmall_7 = (double)nudAreaMinBlack.Value;
                param.AreaMAxSmall_7 = (double)nudAreaMaxBlack.Value;
                param.Hole_7 = ucCheckbox1.Checked;
