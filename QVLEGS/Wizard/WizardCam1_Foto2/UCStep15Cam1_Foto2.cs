...
{
    public partial class UCStep15Cam1_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep15Cam1_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                btnDrawRect1.Text = linguaManager.GetTranslation("BTN_ROI_5_CAM2");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            ucCheckbox1.Checked = param.Hole_5;
            nudAreaMaxBlack.Value = (decimal)param.AreaMAxSmall_5;
            nudAreaMinBlack.Value = (decimal)param.AreaMinSmall_5;

            this.roi1 = new ViewROI.ROIRectangle1();
            this.roi1.setModelData(new HalconDotNet.HTuple(param.smallRect_5.Row1, param.smallRect_5.Column1, param.smallRect_5.Row2, param.smallRect_5.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto2_Step15Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == bigRect_1)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto2_SmallRec_5(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.AreaMinSmall_5 = (double)nudAreaMinBlack.Value;
                param.AreaMAxSmall_5 = (double)nudAreaMaxBlack.Value;
                param.Hole_5 = ucCheckbox1.Checked;
