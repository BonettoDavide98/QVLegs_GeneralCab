...
{
    public partial class UCStep11Cam1_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep11Cam1_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudAreaMaxBlack.Value = (decimal)param.AreaMAxSmall_1;
            nudAreaMinBlack.Value = (decimal)param.AreaMinSmall_1;
            ucCheckbox1.Checked = param.Hole_1;

            this.roi1 = new ViewROI.ROIRectangle1();
            this.roi1.setModelData(new HalconDotNet.HTuple(param.smallRect_1.Row1, param.smallRect_1.Column1, param.smallRect_1.Row2, param.smallRect_1.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto2_Step11Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == bigRect_1)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto2_SmallRec_1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.AreaMinSmall_1 = (double)nudAreaMinBlack.Value;
                param.AreaMAxSmall_1 = (double)nudAreaMaxBlack.Value;
                param.Hole_1 = ucCheckbox1.Checked;
