...
{
    public partial class UCStep10Cam1_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep10Cam1_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Impedenza lat. P";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
                ...
                btnDrawRect1.Text = linguaManager.GetTranslation("BTN_ROI_10_CAM2");
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto2_Step10Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(HalconDotNet.HRegion roi)
        {
            try
            {
