...
{
    public partial class UCStep1Cam1_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep1Cam1_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblAreaMax.Text = linguaManager.GetTranslation("LBL_AREA_MAX_CIRCLE_1_CAM1_FOTO1");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMin.Value = (decimal)param.ThresholdCircle1;
            nudAreaMaxCircle.Value = (decimal)param.AreaMaxCircle1;

            this.roi1 = new ViewROI.ROICircle();
            this.roi1.setModelData(new HalconDotNet.HTuple(param.Circle1.Row, param.Circle1.Column, param.Circle1.Radius));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto1_Step1Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN1)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto1_Circle1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdCircle1 = (double)nudThresholdMin.Value;
                param.AreaMaxCircle1 = (double)nudAreaMaxCircle.Value;
