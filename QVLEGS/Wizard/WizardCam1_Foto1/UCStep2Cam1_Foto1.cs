...
{
    public partial class UCStep2Cam1_Foto1 : TSWizards.BaseExteriorStep
    {

        private const int ROI_MAIN2 = 2;
        ...
        private ViewROI.ROICircle roi2 = null;

        #endregion Variabili Private

        public UCStep2Cam1_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblWhiteThresholdMin.Text = linguaManager.GetTranslation("LBL_THRESHOLD_CIRCLE_2_CAM1_FOTO1");
                lblAreaMax.Text = linguaManager.GetTranslation("LBL_AREA_MAX_CIRCLE_2_CAM1_FOTO1");
                btnDrawCircle2.Text = linguaManager.GetTranslation("BTN_ROI_CIRCLE");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMin.Value = (decimal)param.ThresholdCircle2;
            nudAreaMaxCircle.Value = (decimal)param.AreaMaxCircle2;

            this.roi2 = new ViewROI.ROICircle();
            this.roi2.setModelData(new HalconDotNet.HTuple(param.Circle2.Row, param.Circle2.Column, param.Circle2.Radius));
            this.hWndCtrlManager.SetRoiWithValueNoReset(roi2, ROI_MAIN2);
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto1_Step2Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN2)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto1_Circle2(data);
                    this.roi2 = (ViewROI.ROICircle)roi;
                }
            }
            catch (Exception) { }
        }
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdCircle2 = (double)nudThresholdMin.Value;
                param.AreaMaxCircle2 = (double)nudAreaMaxCircle.Value;
        ...
        private void btnDrawCircle2_Click(object sender, EventArgs e)
        {
            try
            {
                this.hWndCtrlManager.NessunaModalita();
                this.hWndCtrlManager.SetDraw(false, Utilities.UCHWndCtrlManager.ToolType.None);
                this.hWndCtrlManager.SetRoiNoReset(new ViewROI.ROICircle(), ROI_MAIN2);
