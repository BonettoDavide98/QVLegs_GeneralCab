...
{
    public partial class UCStep4Cam1_Foto1 : TSWizards.BaseExteriorStep
    {

        private const int ROI_MAIN4 = 4;
        ...
        private ViewROI.ROICircle roi4 = null;

        #endregion Variabili Private

        public UCStep4Cam1_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblWhiteThresholdMin.Text = linguaManager.GetTranslation("LBL_THRESHOLD_CIRCLE_4_CAM1_FOTO1");
                lblAreaMax.Text = linguaManager.GetTranslation("LBL_AREA_MAX_CIRCLE_4_CAM1_FOTO1");
                btnDrawCircle4.Text = linguaManager.GetTranslation("BTN_ROI_CIRCLE");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMin.Value = (decimal)param.ThresholdCircle4;
            nudAreaMaxCircle.Value = (decimal)param.AreaMaxCircle4;

            this.roi4 = new ViewROI.ROICircle();
            this.roi4.setModelData(new HalconDotNet.HTuple(param.Circle4.Row, param.Circle4.Column, param.Circle4.Radius));
            this.hWndCtrlManager.SetRoiWithValueNoReset(roi4, ROI_MAIN4);
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam1_Foto1_Step4Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN4)
                {
                    this.algoritmoWizard.SetRoiCam1_Foto1_Circle4(data);
                    this.roi4 = (ViewROI.ROICircle)roi;
                }
            }
            catch (Exception) { }
        }
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdCircle4 = (double)nudThresholdMin.Value;
                param.AreaMaxCircle4 = (double)nudAreaMaxCircle.Value;
        ...
        private void btnDrawCircle4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.hWndCtrlManager.SetRoiNoReset(new ViewROI.ROICircle(), ROI_MAIN4);
