...
{
    public partial class UCStep3Cam2_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep3Cam2_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDistMax.Text = linguaManager.GetTranslation("LBL_AREA_MAX_RIGHT");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMax.Value = (decimal)param.ThresholdRight;
            nudDistMax.Value = (decimal)param.AreaMaxRight;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectBlackRight.Row1, param.RectBlackRight.Column1, param.RectBlackRight.Row2, param.RectBlackRight.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam2_Foto1_Step3Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiRightCam2_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdRight = (double)nudThresholdMax.Value;
                param.AreaMaxRight = (double)nudDistMax.Value;
