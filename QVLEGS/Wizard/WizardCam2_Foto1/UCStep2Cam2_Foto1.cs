...
{
    public partial class UCStep2Cam2_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        //MODIFY ON NEW STEP
        public UCStep2Cam2_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
        ...
        {
            DataType.Cam2_Foto1Param param = paramAlg.Cam2_Foto1Param;
            nudThreshold.Value = (decimal)param.ThresholdLeft;
            nudDistMax.Value = (decimal)param.AreaMaxLeft;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectBlackLeft.Row1, param.RectBlackLeft.Column1, param.RectBlackLeft.Row2, param.RectBlackLeft.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam2_Foto1_Step2Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiLeftCam2_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                DataType.Cam2_Foto1Param param = this.algoritmoWizard.GetAlgoritmoParam().Cam2_Foto1Param;
                param.ThresholdLeft = (double)nudThreshold.Value;
                param.AreaMaxLeft = (double)nudDistMax.Value;
