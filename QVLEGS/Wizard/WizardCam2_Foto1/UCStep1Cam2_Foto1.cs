...
{
    public partial class UCStep1Cam2_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        public UCStep1Cam2_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblThresholdMax.Text = linguaManager.GetTranslation("LBL_THRESHOLD_WIDTH_CAM2");
                lblDistMax.Text = linguaManager.GetTranslation("LBL_DIST_MAX_CAM2");
                btnDisegnaRettangolo.Text = linguaManager.GetTranslation("BTN_ROI_WIDTH_CAM2");
        ...
        private void Object2Form(DataType.ParametriAlgoritmo paramAlg)
        {
            ...
            nudThresholdMax.Value = (decimal)param.ThresholdPin;
            nudDistMax.Value = (decimal)param.DistMax;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.RectPin.Row1, param.RectPin.Column1, param.RectPin.Row2, param.RectPin.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam2_Foto1_Step1Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiWidthCam2_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                param.ThresholdPin = (double)nudThresholdMax.Value;
                param.DistMax = (double)nudDistMax.Value;
