...
{
    public partial class UCStep1Cam5_Foto2 : TSWizards.BaseExteriorStep
    {
        ...
        //MODIFY ON NEW STEP
        public UCStep1Cam5_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Controllo integrità";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
                ...
                lblThresholdMax.Text = linguaManager.GetTranslation("LBL_THRESHOLD_LEFT_CAM2");
                lblDistMax.Text = linguaManager.GetTranslation("LBL_AREA_MAX_LEFT");
                btnDisegnaRettangolo.Text = linguaManager.GetTranslation("BTN_ROI_LEFT_CAM2");
        ...
        {
            DataType.Cam5_Foto2Param param = paramAlg.Cam5_Foto2Param;
            nudThreshold.Value = (decimal)param.ThresholdMax;
            nudDistMax.Value = (decimal)param.AreaMin;

            this.roi = new ViewROI.ROIRectangle1();
            this.roi.setModelData(new HalconDotNet.HTuple(param.Roi.Row1, param.Roi.Column1, param.Roi.Row2, param.Roi.Column2));
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam5_Foto2_Step1Wizard(image, 2, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiCam5_Foto2(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                DataType.Cam5_Foto2Param param = this.algoritmoWizard.GetAlgoritmoParam().Cam5_Foto2Param;
                param.ThresholdMax = (double)nudThreshold.Value;
                param.AreaMin = (double)nudDistMax.Value;
