...
{
    public partial class WizardCam5_Foto2 : TSWizards.BaseWizard
    {

        #region Variabili Private

        private Algoritmi.AlgoritmoWizard algoritmoWizard = null;
        private readonly UCStep1Cam5_Foto2 step1 = null;

        #endregion Variabili Private

        public WizardCam5_Foto2(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                step1 = new UCStep1Cam5_Foto2(appManager, idCamera, core, this.algoritmoWizard, impostazioni, modifica, linguaManager, repaintLock);
        ...
        protected override void OnFinishClicked(EventArgs e)
        {
            ...
            this.algoritmoWizard.SetWizarCam5_Foto2Complete();
