...
{
    public partial class UCStep1Cam5_Foto1 : TSWizards.BaseExteriorStep
    {
        ...
        //MODIFY ON NEW STEP
        public UCStep1Cam5_Foto1(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            try
            {
                ...
                lblDescrizione.Text = "Controllo foro";// linguaManager.GetTranslation("LBL_DESCRIZIONE_INTEGRITA");
        ...
        {
            DataType.Cam5_Foto1Param param = paramAlg.Cam5_Foto1Param;
        ...
        private void EseguiStep(HalconDotNet.HImage image, DataType.PrevImageData prevImageData)
        {
            if (image != null)
            {
                ...
                ArrayList arrayList = this.algoritmoWizard.TestCam5_Foto1_Step1Wizard(image, 1, prevImageData, out DataType.ElaborateResult res);
        ...
        private void OnRoiUpdate(ViewROI.ROI roi)
        {
            try
            {
                ...
                if (roiId == ROI_MAIN)
                {
                    ...
                    this.algoritmoWizard.SetRoiCam5_Foto1(data);
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                DataType.Cam5_Foto1Param param = this.algoritmoWizard.GetAlgoritmoParam().Cam5_Foto1Param;
