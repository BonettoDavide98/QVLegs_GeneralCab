...
{
    public partial class UCEditAlgCam2_Foto1 : UserControl
    {
        ...
        public void CheckForComplete()
        {
            if (this.algoritmoWizard != null)
            {
                ...
                chbEnable.Checked = parametri.Cam2_Foto1Param.AbilitaControllo;
        ...
        private void OpenWizard(bool modifica)
        {
            ...
            try
            {
                ...
                if (!modifica)
                {
                    pAlg.Cam2_Foto1Param?.Dispose();
                    pAlg.Cam2_Foto1Param = new DataType.Cam2_Foto1Param();
                    pAlg.Cam2_Foto1Param.AbilitaControllo = true;
                }

                Wizard.WizardCam2_Foto1 wizard = new Wizard.WizardCam2_Foto1(this.appManager, this.idCamera, core, this.algoritmoWizard, this.impostazioni, modifica, this.linguaManager, this.repaintLock);
        ...
        private void chbEnable_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.simpleDirtyTracker.SetAsDirty();
                this.algoritmoWizard.SetAlgCam2_Foto1Enable(chbEnable.Checked);
                CheckForComplete();
            }
            catch (Exception)
            {
