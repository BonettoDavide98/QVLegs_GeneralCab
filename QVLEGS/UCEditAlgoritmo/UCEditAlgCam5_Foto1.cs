...
{
    public partial class UCEditAlgCam5_Foto1 : UserControl
    {
        ...
        public void Init(int num, Class.AppManager appManager, int idCamera, DataType.Impostazioni impostazioni, Utilities.SimpleDirtyTracker simpleDirtyTracker, DBL.LinguaManager linguaManager, object repaintLock)
        {
            ...
            lblTitolo.Text = linguaManager.GetTranslation("LBL_UC_PARAM_CAM5_FOTO1");
        ...
        public void CheckForComplete()
        {
            if (this.algoritmoWizard != null)
            {
                ...
                chbEnable.Checked = parametri.Cam5_Foto1Param.AbilitaControllo;
        ...
        private void OpenWizard(bool modifica)
        {
            ...
            try
            {
                ...
                if (!modifica)
                {
                    pAlg.Cam5_Foto1Param?.Dispose();
                    pAlg.Cam5_Foto1Param = new DataType.Cam5_Foto1Param();
                    pAlg.Cam5_Foto1Param.AbilitaControllo = true;
                }

                Wizard.WizardCam5_Foto1 wizard = new Wizard.WizardCam5_Foto1(this.appManager, this.idCamera, core, this.algoritmoWizard, this.impostazioni, modifica, this.linguaManager, this.repaintLock);
        ...
        private void chbEnable_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.simpleDirtyTracker.SetAsDirty();
                this.algoritmoWizard.SetAlgCam5_Foto1Enable(chbEnable.Checked);
                CheckForComplete();
            }
            catch (Exception)
            {
