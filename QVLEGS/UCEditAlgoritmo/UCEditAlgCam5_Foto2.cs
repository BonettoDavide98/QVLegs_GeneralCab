...
{
    public partial class UCEditAlgCam5_Foto2 : UserControl
    {
        ...
        public void Init(int num, Class.AppManager appManager, int idCamera, DataType.Impostazioni impostazioni, Utilities.SimpleDirtyTracker simpleDirtyTracker, DBL.LinguaManager linguaManager, object repaintLock)
        {
            ...
            lblTitolo.Text = linguaManager.GetTranslation("LBL_UC_PARAM_CAM5_FOTO2");
            lblNum.Text = num.ToString();
        }

        public void Translate(DBL.LinguaManager linguaManager)
        {
            lblTitolo.Text = linguaManager.GetTranslation("LBL_UC_PARAM_CAM2_FOTO1");
        ...
        public void CheckForComplete()
        {
            if (this.algoritmoWizard != null)
            {
                ...
                chbEnable.Checked = parametri.Cam5_Foto2Param.AbilitaControllo;
        ...
        private void OpenWizard(bool modifica)
        {
            ...
            try
            {
                ...
                if (!modifica)
                {
                    pAlg.Cam5_Foto2Param?.Dispose();
                    pAlg.Cam5_Foto2Param = new DataType.Cam5_Foto2Param();
                    pAlg.Cam5_Foto2Param.AbilitaControllo = true;
                }

                Wizard.WizardCam5_Foto2 wizard = new Wizard.WizardCam5_Foto2(this.appManager, this.idCamera, core, this.algoritmoWizard, this.impostazioni, modifica, this.linguaManager, this.repaintLock);
        ...
        private void chbEnable_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.simpleDirtyTracker.SetAsDirty();
                this.algoritmoWizard.SetAlgCam5_Foto2Enable(chbEnable.Checked);
                CheckForComplete();
            }
            catch (Exception)
            {
