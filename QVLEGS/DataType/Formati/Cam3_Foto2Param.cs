...
namespace QVLEGS.DataType
{
    ...
    public class Cam3_Foto2Param : IDisposable
    {
        ...
        public Rectangle2Param RectHeight_3 { get; set; }
        public double DistMax_Height_3 { get; set; }
        public double DistMin_Height_3 { get; set; }
        public Cam3_Foto2Param()
        {
            ...
            this.RectHeight_3 = new Rectangle2Param();
            this.DistMax_Height_3 = 10;
            this.DistMin_Height_3 = 5;
        }
